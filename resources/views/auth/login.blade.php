...
<div class="container-fluid p-0">
    <div class="row g-0 min-vh-100">
        <!-- Left Side: Photo & Branding Overlay -->
        <div class="col-lg-6 d-none d-lg-block p-0">
            <div class="auth-left-banner">
                ...
                <div class="auth-left-text">
                    <h1 class="auth-left-title">Selamat Datang Kembali</h1>
                    <p class="auth-left-desc">Masuk ke akun Anda untuk mengelola jadwal konsultasi dan terhubung dengan terapis profesional Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-12 auth-right-container">
            <div class="auth-form-wrapper">
                ...
                <h2 class="auth-form-title">Masuk Akun</h2>
                <p class="auth-form-subtitle">Masukkan email dan password Anda untuk masuk.</p>
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <a href="javascript:void(0)" onclick="alert('Silakan hubungi administrator atau masukkan email Anda untuk reset password.')" class="small link-purple">Lupa Password?</a>
                        </div>
                        <div class="input-group input-group-custom">
                    ...
                    <div class="text-center small text-muted">
                        Belum memiliki akun? <a href="{{ route('register') }}" class="link-purple">Daftar</a>
                    </div>
                </form>

                <!-- Demo Credentials Info -->
                <div class="mt-4 pt-3 border-top text-center">
                    <span class="badge bg-light text-secondary mb-2">Demo Credentials:</span>
                    <div class="d-flex flex-wrap justify-content-center gap-2 small">
                        <span class="text-muted">Admin: <code>admin@terapis.com</code></span>
                        <span class="text-muted">| Pasien: <code>user@terapis.com</code></span>
                        <span class="text-muted">| Terapis: <code>therapist@terapis.com</code></span>
                        <div class="w-100 text-muted">Password: <code>password</code></div>
                    </div>
                </div>
            </div>
        </div>
